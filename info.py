...
API_ID = int(environ.get('API_ID', '20713353'))
API_HASH = environ.get('API_HASH', 'ed4d76e20f4e1bef6e834999547fd22e')
BOT_TOKEN = environ.get('BOT_TOKEN', "8057929734:AAFtYVF3TM8LHdye_aFufsE9pl0wMNMJHNc")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5813088212').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002142549234'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003082572186').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002700010340') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://piyushpushpad255_db_user:LBBenpybGS1keMvz@cluster0.fal0i2q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'bc1628482d495ac0eac4f3024966ef48a74baa35')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/kingpaytham/20') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
